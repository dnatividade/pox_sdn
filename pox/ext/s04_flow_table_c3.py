...
rules = [ ['100','*','*','00:00:00:00:00:01','*','*','*','*','*','*','*','3'],
          ['100','*','*','00:00:00:00:00:02','*','*','*','*','*','*','*','3'],
          ['100','*','*','00:00:00:00:00:03','*','*','*','*','*','*','*','3'],
          ['100','*','*','00:00:00:00:00:04','*','*','*','*','*','*','*','3'],
          ['100','*','*','00:00:00:00:00:05','*','*','*','*','*','*','*','3'],
          ['100','*','*','00:00:00:00:00:06','*','*','*','*','*','*','*','3'],
          ['100','*','*','00:00:00:00:00:07','*','*','*','*','*','*','*','3'],
          ['100','*','*','00:00:00:00:00:08','*','*','*','*','*','*','*','3'],

          ['100','*','*','00:00:00:00:00:09','*','*','*','*','*','*','*','1'],
          ['100','*','*','00:00:00:00:00:10','*','*','*','*','*','*','*','1'],

          ['100','*','*','00:00:00:00:00:11','*','*','*','*','*','*','*','2'],
          ['100','*','*','00:00:00:00:00:12','*','*','*','*','*','*','*','2'] ]
