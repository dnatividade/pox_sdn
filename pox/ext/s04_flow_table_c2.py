...
rules = [ ['100','*','*','00:00:00:00:00:01','*','*','*','*','*','*','*','2'],
          ['100','*','*','00:00:00:00:00:02','*','*','*','*','*','*','*','2'],
          ['100','*','*','00:00:00:00:00:03','*','*','*','*','*','*','*','2'],
          ['100','*','*','00:00:00:00:00:04','*','*','*','*','*','*','*','2'],
          ['100','*','*','00:00:00:00:00:05','*','*','*','*','*','*','*','2'],
          ['100','*','*','00:00:00:00:00:06','*','*','*','*','*','*','*','2'],

          ['100','*','*','00:00:00:00:00:07','*','*','*','*','*','*','*','1'],
          ['100','*','*','00:00:00:00:00:08','*','*','*','*','*','*','*','1'],

          ['100','*','*','00:00:00:00:00:09','*','*','*','*','*','*','*','3'],
          ['100','*','*','00:00:00:00:00:10','*','*','*','*','*','*','*','3'],
          ['100','*','*','00:00:00:00:00:11','*','*','*','*','*','*','*','3'],
          ['100','*','*','00:00:00:00:00:12','*','*','*','*','*','*','*','3'] ]
